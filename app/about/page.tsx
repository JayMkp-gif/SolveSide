    ...
    <>
      ...
      <section className="bg-gradient-to-r from-primary to-secondary py-16 text-white md:py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <AnimatedSection>
            <div className="mx-auto max-w-3xl text-center">
              <h2 className="mb-4 text-3xl font-bold tracking-tight sm:text-4xl">Join Our Mission</h2>
              <p className="mb-8 text-lg text-white/90">
                There are many ways to support Solve Side Academy and make a difference in the lives of young people.
              </p>
